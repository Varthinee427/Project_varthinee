...
class Authen : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val button = view.findViewById(R.id.login) as Button
        val textUser = view.findViewById(R.id.user) as EditText
        val textPass = view.findViewById(R.id.pass) as EditText

        button.setOnClickListener {

            val fmProfile = Profile().newInstance2(textUser.text.toString(), textPass.text.toString())
            val mg = fragmentManager
            mg!!.beginTransaction().replace(R.id.layout, fmProfile, "").commit()
